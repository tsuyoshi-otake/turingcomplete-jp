...
インストール後、ゲーム内の設定で言語を「Japanese」に変更してください。
...
アンインストール時にオリジナルの Japanese.txt が復元されます。

> **Note:** Steamのアップデートで翻訳ファイルが上書きされた場合、再度インストーラーを実行してください。

### 手動インストール

MSI を使わない場合は、`mod/translations/Japanese.txt` を以下にコピーしてください:
